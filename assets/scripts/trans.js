const dict = {
    ...
    "WE CREATE YOUR GREAT IMAGINATION": {
        'en': "WE CREATE YOUR GREAT IMAGINATION",
        'es': "Creamos tu gran Imaginación",
        'fr': "NOUS CRÉONS VOTRE GRANDE IMAGINATION"
    },
    "Works on first class vinyl for all types of vehicles.": {
        'en': "Works on first class vinyl for all types of vehicles.",
        'es': "Trabajos en vinilos de primera clase para todo tipo de vehículos.",
        'fr': "Fonctionne sur vinyle de première classe pour tous les types de véhicules."
    },
    "Elegant interior and exterior designs for all kinds of stores, pharmacies, festivals ...": {
        'en': "Elegant interior and exterior designs for all kinds of stores, pharmacies, festivals ...",
        'es': "Diseños elegantes interiores y exteriores para todo tipo de tiendas, farmacias, festivales...",
        'fr': "Design intérieur et extérieur élégant pour toutes sortes de magasins, pharmacies, festivals ..."
    },
    "Countless first class customers have us at your disposal throughout Europe.": {
        'en': "Countless first class customers have us at your disposal throughout Europe.",
        'es': "Innumerables clientes de primera clase nos tienen a su disposición en toda Europa.",
        'fr': "D'innombrables clients de premier ordre nous ont mis à votre disposition dans toute l'Europe."
    },
    "Description": {
        'en': "Description",
        'es': "Descripción",
    ...
    "With the proposal to offer an excellent service, we have access to a wide range of clients in the management, production and logistic areas. A global servicio that allows guaranteed to el el mejor producto.": {
        'en': "With the proposal to offer an excellent service, we have access to a wide range of clients in the management, production and logistic areas. A global servicio that allows guaranteed to el el mejor producto.",
        'es': "Con el propósito de ofrecer un excelente servicio, ponemos a disposición de nuestros clientes nuestro conocimiento en gestión, producción y logística. Un servicio global que permite garantizar el mejor producto.",
        'fr': "Dans le but d'offrir un excellent service, nous offrons à nos clients nos connaissances en gestion, production et logistique. Un service global qui garantit le meilleur produit."
    },
    "Specialists in illuminated signs, banners, corporeal letters, vehicle signage, boats, shop windows, small and large format digital printing and different graphic communication supports for the production and installation of all types of advertising elements, decoration of spaces, events and we have given coverage in different countries such as Spain, Portugal, France, Italy and Germany.": {
        'en': "Specialists in illuminated signs, banners, corporeal letters, vehicle signage, boats, shop windows, small and large format digital printing and different graphic communication supports for the production and installation of all types of advertising elements, decoration of spaces, events and we have given coverage in different countries such as Spain, Portugal, France, Italy and Germany.",
        'es': "Especialistas en rótulos luminosos, banderolas, letras corpóreas, rotulación de vehículos, barcos, escaparates, impresión digital pequeño y gran formato y diferentes soportes de comunicación gráfica para la producción e instalación de todo tipo de elementos publicitarios, decoración de espacios, eventos y hemos dado cobertura en diferentes países como España, Portugal, Francia, Italia e Alemania.",
        'fr': "Spécialistes en enseignes lumineuses, bannières, lettres corporelles, signalisation de véhicules, bateaux, vitrines, impression numérique grand et petit format et différents supports de communication graphique pour la production et l'installation de tous types d'éléments publicitaires, décoration d'espaces, événements et couverture dans différents pays tels que l'Espagne, le Portugal, la France, l'Italie et l'Allemagne."
    },
    "Service maintenance and repair of luminous, we also create your corporate image.": {
        'en': "Service maintenance and repair of luminous, we also create your corporate image.",
        'es': "Servicio de mantenimiento y reparación de luminosos, también creamos su imagen corporativa.",
        'fr': "Service maintenance et réparation de luminaires, nous créons également votre image d'entreprise."
    },
    "Today we are proud of the results obtained and happy to offer a service recognized by our customers, without them it would not be possible to value our work.": {
        'en': "Today we are proud of the results obtained and happy to offer a service recognized by our customers, without them it would not be possible to value our work.",
        'es': "A día de hoy nos sentimos orgullosos por los resultados obtenidos y felices por ofrecer un servicio reconocido por nuestros clientes, sin ellos no seria posible valorar nuestra labor.",
        'fr': "Aujourd'hui, nous sommes fiers des résultats obtenus et heureux d'offrir un service reconnu par nos clients, sans eux, il ne serait pas possible de valoriser notre travail."
    },
    "Contact information": {
